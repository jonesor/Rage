...
#'
#' @description 
#' Calculate generation time from a matrix population model. Multiple definitions of the
#' generation time are supported: the time required for a population to increase by a factor
#' of R0 (the net reproductive rate; Caswell (2001), section 5.3.5), the average
#' parent-offspring age difference (Bienvenu & Legendre (2015)), or the expected age at
#' reproduction for a cohort (Coale (1972), p. 18-19).
#'
...
#' equal to \code{sum(x lx mx) / sum(lx mx)} (Coale (1972), p. 18-19). Here, \code{x} is 
#' age, \code{lx} is age-specific survivorship, and \code{mx} is age-specific fertility.
#' See functions \code{mpm_to_lx} and \code{mpm_to_mx} for details about the conversion of
#' matrix population models to life tables.
#' 
...
#' 
#' @references Bienvenu, F. & Legendre, S. 2015. A New Approach to the Generation Time in
#'  Matrix Population Models. The American Naturalist 185 (6): 834–843. doi:10.1086/681104.
#'  
#' Caswell, H. 2001. Matrix Population Models: Construction,
#'   Analysis, and Interpretation. Sinauer Associates; 2nd edition. ISBN:
#'   978-0878930968
#'   
#' Coale, A.J. 1972. The Growth and Structure of Human Populations. Princeton University
#'   Press. ISBN: 978-0691093574
#' 
#' @examples
#' data(mpm1)
#' 
