...
test_that("id_repro_stages works correctly", {
  ...
  x_na_1 <- id_repro_stages(mat_f_na, na_handling = "return.true")
  x_na_2 <- id_repro_stages(mat_f_na, na_handling = "return.na")
  x_na_3 <- id_repro_stages(mat_f_na, na_handling = "return.false")
...
test_that("id_repro_stages warns and fails gracefully", {
  ...
  expect_error(id_repro_stages(mat_f, na_handling = "eigen"))
})
