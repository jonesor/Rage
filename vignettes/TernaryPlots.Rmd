...
for(i in 1:length(Umats)){
  temp <- Rage::matrixElementPerturbation(Umats[[i]],   #The same issue as above
                                          Fmats[[i]],
                                          Cmats[[i]])
...
output$reproduciton[i] <- temp$fecundity + temp$clonality
