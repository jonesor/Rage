...
|-----------------------------------------|----------------------------------|
| 1. [Vital rates](#vitalrates)  | [VitalRates](vignette:a02_VitalRates)     |
| 2. [Life tables](#lifetable) | [AgeFromStage](vignette:a03_AgeFromStage) |
| 3. [Perturbation analysis](#perturb)    | n/a |
| 4. [Deriving life history traits](#lifehist) | [LifeHistoryTraits](vignette:a05_LifeHistoryTraits) |
| 5. [Transformation of matrices](#maniptransform) | n/a                                   |
"
cat(tabl)
```

A full list of functions by category is available at the [documentation webpage](reference/).
...
[Vital Rates vignette](vignette:a02_VitalRates).
...
We refer readers to the [AgeFromStage vignette](vignette:a03_AgeFromStage) for further
...
below, referring the reader to the [LifeHistoryTraits vignette](vignette:a05_LifeHistoryTraits)
and the [documentation webpage](reference/) 
