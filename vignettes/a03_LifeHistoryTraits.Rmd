...
entropy_d(lx = mpm1$matU, mx = mpm1$matF) # Demetrius' entropy

life_elas(lx) # Keyfitz' entropy
life_elas(lx = mpm1$matU) # Keyfitz' entropy
...
de Vries, C., Bernard, C., & Salguero-Gómez, R. 2023. Discretising Keyfitz' entropy for studies of actuarial senescence and comparative demography. Methods in Ecology and Evolution, 14, 1312–1319. <https://doi.org/10.1111/2041-210X.14083>
